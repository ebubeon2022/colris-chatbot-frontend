        ...
        <div style="display:flex;flex-direction:column;gap:8px;max-width:85%;">
          ...
          <div v-if="message.isFallback" class="handoff-card">
            ...
            <div class="handoff-actions">
              <a href="https://clr.covenantuniversity.edu.ng/ask-a-librarian/" target="_blank" class="handoff-btn primary">✉️ Contact a Librarian</a>
            </div>
...
.message.user .message-bubble { background: #1a0f0a; color: #fdf6e3; border-bottom-right-radius: 4px; box-shadow: 0 2px 8px rgba(0,0,0,0.15); width: fit-content; max-width: 100%; }
